(function () {
  ...
  /**
   * @type {string}
   * @description the info about the package
   */
  var data = `process is running ...\nPackage name: ${name}. Version: ${version}.\n`;
